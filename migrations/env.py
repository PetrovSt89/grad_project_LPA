...
# from models.models import Base as Base_mod
...
from src.config import DB_USER, DB_PORT, DB_HOST, DB_NAME, DB_PASS
...
# target_metadata = [Base_mod, Base_auth, Base_operations]
